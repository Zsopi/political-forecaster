...
it would be god to have a logit regression as well
...
##Let's see how 2016 looks like in terms of political trouble predicitons. Worst countries are at the top, based on avg_predict (last column), which is the average of the three machine learning prediction probabilities (GBM, RF, DL). This is the final test of the model, but can be evaluated only next year :) However, the results look broadly pausible...
...
### * But it has been fun so far and I learned a lot :) in the hard way :)
